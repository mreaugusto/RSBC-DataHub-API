...
routes = [
    ...
    dict(resource=Impoundments, urls=['/impoundments/<impoundmentId>/<correlationId>'], endpoint='impoundments_impoundmentId_correlationId'),
    dict(resource=Search, urls=['/search/<correlationId>'], endpoint='search_correlationId'),
    dict(resource=Prohibitions, urls=['/prohibitions/<correlationId>'], endpoint='prohibitions_correlationId'),
    dict(resource=Prohibitions, urls=['/prohibitions/<prohibitionId>/<correlationId>'], endpoint='prohibitions_prohibitionId_correlationId'),
    dict(resource=Document, urls=['/documents/<documentId>/<correlationId>'], endpoint='documents_get'),
    dict(resource=DocumentsList, urls=['/documents/<correlationId>'], endpoint='documents_index'),
